...
websiteApp.controller('NovaZagoraController',
    function NovaZagoraController($scope) {
        var novaZagoraInfo = {
            ...
            teritory: 'Град Нова Загора е разположен в северната част на Горнотракийската низина. о̀ва Заго̀ра е град в Централна България, Област Сливен, на 32 км източно от Стара Загора и 37 километра западно от Сливен. Градът е втори по големина в областта след Сливен и е административен център на Община Нова Загора.',
